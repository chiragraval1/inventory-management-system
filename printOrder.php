...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td rowspan="6" colspan="2" style="border-left:1px solid black;" background-image="logo1.jpg"><img src=".//logo1.jpeg" alt="logo" width="150px;"></td>
                     <td colspan="3" style=" text-align: right;">RAGHAV</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">GENERAL STORE</td>
                  </tr>
            
                  <tr>
                     <td colspan="3" style=" text-align: right;">Mota Chiloda Gandhinagar, GUJARAT,</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">gandhinagar,382355</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">Tele: 8758410228.</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;color: blue;text-decoration: underline;">chandrakantraval9898@email.com</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     <td style="width: 123px;text-align: center;background-color: #EEEEEE;color: black;border-right: 1px solid black;-webkit-print-color-adjust: exact;">D.C.NO<br>
                        &amp;DATE
                     </td>
                     <td style="width: 50%;text-align: center;border-top-style: solid;border-right-style: solid;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: white;border-bottom-color: black;color: black;background-color: #EEEEEE;-webkit-print-color-adjust: exact;">Description Of Goods</td>
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-right-style: solid;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: #fff;border-bottom-color: black;background-color: #EEEEEE;color: black;-webkit-print-color-adjust: exact;">Qty.</td>
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-right-style: solid;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: #fff;border-bottom-color: black;background-color: #EEEEEE;color: black;-webkit-print-color-adjust: exact;">Rate&nbsp; Rs.<br>
                        Ps
                     </td>
                     <td style="width: 150px;text-align: center;border-top-style: solid;border-right-style: solid;border-bottom-style: solid;border-top-width: thin;border-right-width: thin;border-bottom-width: thin;border-top-color: black;border-right-color: black;border-bottom-color: black;color: black;background-color: #EEEEEE;-webkit-print-color-adjust: exact;">Amount&nbsp; Rs.<br>
                        &nbsp;Ps
                     </td>
                  </tr>';
                  $x = 1;
            ...
            $x++;
                ...
                $table.= '
                  ...
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;border-bottom: 1px solid black;padding: 5px;border-right: 1px solid black;">RAGHAV GENERAL STORE <span style="float: right;"> E.&amp;.O.E.</span></td>
